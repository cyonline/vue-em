            ...
            <div class="charts_container">
                ...
                <div class="bottom-content">
                  <div class="content-data">
                    <div class="data-item">
                      <span>实测合格率</span>
                      <span>{{dataList.MeasuredPassRateScore}}</span>
                    </div>
                  ...
                  <div class="content-data">
                    ...
                    <div class="data-item ml-20">
                      <span>功能性试验</span>
                      <span>{{dataList.FunctionalTestScore}}</span>
                    </div>
                  </div>
                </div>
            </div>
...
export default {
  ...
  methods: {
    doMore: function() {
        var content = '/pages/em/thirdPartyEvaluationControl/checkEvalResult/checkEvalResult.html?layer=1&menuId=layer&assessType=1&stageId=' + this.structId
        layer.open({
            type: 2,
            title: ["详情"],
            shade: 0.001,
    ...
    fetchData: function () {
      ...
      this.$request('/api/engineeringReportBoard/thirdParityAssess', subData)
        .then(function (res) {
          vm.chartData = {
              series: [{
                  data: [{
