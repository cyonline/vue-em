      ...
      <article ref="mainContent" class="lookboard_panel_content">
        <div class="box">
          <div class="left-side">
            ...
            <div class="username">cy</div>
            <div class="userType">超级管理员</div>
          </div>
          <div class="right-side">
            <div class="form-box">
              <el-form ref="userForm" v-model="userInfo" label-width="80px" size="small" label-position="top">
                <el-form-item label="用户名" prop="username">
                  <el-input v-model="userInfo.name" placeholder="请输入用户名"></el-input>
                </el-form-item>
                <el-form-item label="邮箱" prop="email">
                  <el-input v-model="userInfo.email" placeholder="example@163.com"></el-input>
                </el-form-item>
                <el-form-item label="个人简介" prop="intro">
                  <el-input type="textarea" v-model="userInfo.intro" height="80" placeholder="请输入个人简介"></el-input>
                </el-form-item>
                <el-form-item>
                  <el-button type="primary" size="mimedium"  @click="submitForm('userForm')">更新</el-button>
